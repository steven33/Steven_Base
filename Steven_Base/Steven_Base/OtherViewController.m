...
#import "AnothorViewController.h"
...
{
    if (sender.tag == 0) {
        [self.navigationController pushViewController:[[AnothorViewController alloc] init] animated:YES];
    }else{
        [self presentViewController:[[AnothorViewController alloc] init] animated:YES completion:^{
